...
class HistoryViewModelFactory(private val context: Context) :
    ...
    companion object {
        private const val LOG_TAG = "448.HistoryViewModelFactory"
    }

    fun getViewModelClass() = HistoryViewModel::class.java
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        if (modelClass.isAssignableFrom(getViewModelClass())) {
            ...
            return modelClass
                .getConstructor(HistoryRepo::class.java)
                .newInstance(HistoryRepo.getInstance(context))
        }
