package com.csci448.hadam.monsterlab.data
...
object MonsterRepo {
    public var monsters =
        ...
        Monster(imageId = R.drawable.monsters_university_art_icon,
        ...
        Monster(imageId = R.drawable.monsters_university_mascot_icon,
        nameId = R.string.name_mascot_archie,
        descId = R.string.name_mascot_archie),
        Monster(imageId = R.drawable.monsters_university_terry_icon,
