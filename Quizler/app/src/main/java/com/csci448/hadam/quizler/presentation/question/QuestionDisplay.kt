...
fun QuestionDisplay(
    ...
    val incorrectButtonColors =
        ButtonDefaults.buttonColors(disabledContainerColor = Red40, disabledContentColor = Gold60)
...
fun PreviewQuestionDisplay() {
    QuestionDisplay(
        question = QuestionRepo.questions.first(),
        onCheatAnswer = { },
        onCorrectAnswer = { },
        onWrongAnswer = {},
...
fun PreviewMultiQuestionDisplay() {
    QuestionDisplay(
        question = QuestionRepo.questions.last(),
        onCheatAnswer = { },
        onCorrectAnswer = { },
        onWrongAnswer = {},
